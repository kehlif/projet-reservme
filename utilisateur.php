            ...
            <tbody>
                          <?php
                            ...
                            <tr>
                              ...
                              <td><a style="background: red; text-decoration: none; color:white; margin:10px; border-radius:5px; padding:5px;" href="suppr_u.php?id_u=<?php echo $data['id_utilisateur']; ?>">supprimer</a></td>
                            </tr>
                          <?php endforeach; ?>
                  </tbody>
              </table>
