...
$con = new PDO ('mysql:host=localhost;dbname=id3146784_reservme','id3146784_kehli','papounetweb');
  ...
  // echo "connecté";
      ...
      $statement = $con->prepare("SELECT s.id_salle, s.nom as label
      FROM reservation r JOIN utilisateur u JOIN salle s WHERE r.id_u = u.id_utilisateur AND
      r.id_salle = s.id_salle AND id_reservation = :id ");
  ...
  <body>
    <header id="haut-page">
      <div class="entete">
        ...
        <h2>Reserv'me</h2>
        <?php
        echo "<p style='color:white; margin-left:84%;margin-top:28px;font-size:24px;'>" .$_SESSION['nom']."</p>";
        ?>
    ...
    <form id="modification" class="" action="traitement-modif-admin.php" method="post">
