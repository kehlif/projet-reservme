            ...
            <tbody>
                          <?php
                            ...
                            <tr>
                              ...
                              <td><a style="" href="modifier_admin.php?id=<?php echo $data['id_reservation']; ?>">modifier</a></td>
                              <td><a style="background: red; text-decoration: none; color:white; margin:10px; border-radius:5px; padding:5px;" href="supprimer_admin.php?id=<?php echo $data['id_reservation']; ?>">supprimer</a></td>
                            </tr>
                          <?php endforeach; ?>
                  </tbody>
              </table>
