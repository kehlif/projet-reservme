...
<html>
  ...
  <body>
    ...
    <h2>Salle Réservées</h2>
      <div id="box-details">
    <?php foreach ($data as $datas): ?>
      <div class="detail">
      <label for="">Nom Salle: </label><p class="text"><?php echo $datas['label']; ?></p><br>
      <label for="">Date Début: </label><p class="text"><?php echo strftime('%d-%m-%y',strtotime($datas['date_debut'])); ?></p><br>
      <label for="">Date fin: </label><p class="text"><?php echo strftime('%d-%m-%y',strtotime($datas['date_fin'])); ?></p><br>
      <label for="">Heure Debut: </label><p class="text"><?php echo $datas['heure_debut']; ?></p><br>
      <label for="">Heure Fin: </label><p class="text"><?php echo $datas['heure_fin']; ?></p><br>
    </div>
    <?php endforeach; ?>
  </div>
